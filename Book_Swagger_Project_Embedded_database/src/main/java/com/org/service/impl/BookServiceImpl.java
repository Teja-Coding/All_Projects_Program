...
public class BookServiceImpl implements BookService {
	...
	@Override
	public Book updateBookDate(Integer id, Book book) {
		// TODO Auto-generated method stub
		Book existData=bookRepository.findById(id)
				.orElseThrow(() -> new IllegalArgumentException("Data not found with id: " + id));
		existData.setBookName(book.getBookName());
		existData.setBookPrice(book.getBookPrice());
		return bookRepository.save(existData);
	}
