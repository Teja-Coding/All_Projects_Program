...
public class MMTServiceImpl implements MMTService{
	...
	public Ticket bookTicket(Passenger passenger) {
		...
		String bookUrl= "http://13.235.113.21:8080/irctc/bookTicket";
	...
	public Ticket getTicket(Integer ticketId) {
		String getUrl= "http://13.235.113.21:8080/irctc/getTicket/{id}";
	...
	public List<Ticket> getAllTickets(){
		String getAllUrl= "http://13.235.113.21:8080/irctc/getAllTickets";
	...
	public String deleteTicket(Integer ticketId) {
		String url = "http://13.235.113.21:8080/irctc/deleteTicket/{id}";
	...
	public Ticket updateTicket(Passenger passenger, Integer ticketId) {
		String updateUrl= "http://35.154.164.122:8080/irctc/updateTicket/{id}";
